...
@Repository
public interface ECollectorRepository<T extends ECollector> extends org.springframework.data.repository.Repository<T, Integer>{
...
//
//@NoRepositoryBean
//interface BaseRepository<T> extends JpaRepository<Collector, Integer>{
//	public Optional<Collector> findById(Integer id);
//}
//@NoRepositoryBean
//interface BasicRepository extends org.springframework.data.repository.Repository<BasicCollector, Integer>{
//	public Optional<BasicCollector> findByPk(Integer id);
//}